...
Record BRAM_DUAL_PORT (addr : Kind) (data : Kind) := {
    BRAM_DUAL_PORT'modules: Modules;
...
Module module'mkBRAMCore1.
    ...
    Variable addr_sz: nat.
    Variable data_sz: nat.
                   Let d : string := instancePrefix--"d".
    Definition mkBRAMCore1Module: Modules.
        refine  (BKMODULE {
    ...
    }); abstract omega. Qed. (* mkBRAMCore1 *)

(* Module mkBRAMCore1 type Integer -> Bool -> Module#(BRAM_PORT#(addr, data)) return type Bool *)
    Definition mkBRAMCore1 := Build_BRAM_PORT mkBRAMCore1Module%kami (instancePrefix--"put") (instancePrefix--"read").
    End Section'mkBRAMCore1.
End module'mkBRAMCore1.

Definition mkBRAMCore1 := module'mkBRAMCore1.mkBRAMCore1.
